...
export const blackPainting = defineWork<Params>({
  ...
  aspectRatio: 1,
  caption:
    'The Getty Tomb (similar to the "nested-u" option) is a huge (84 x 96 in) painting in LACMA\'s collection in Los Angeles. If you are in LA, I recommend making a day out of the La Brea Tar Pits and then LACMA. Toggle Perlin noise to simulate the canvas it was painted on.',
  defaultParams: {
    bandCount: 11,
    pinstripe: 2,
